...
<body>
	...
	<section class="container">
		<form:form id="customer" modelAttribute="order.customer"
			...
			<fieldset>
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
						...
						<c:forEach items="${flowRequestContext.messageContext.getMessagesBySource('name')}"
							var="message">
							<div class="text-danger">${message.text}</div>					
						</c:forEach>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
						<form:input id="phoneNumber" path="phoneNumber" type="text"
							class="form:input-large" />
						<c:forEach items="${flowRequestContext.messageContext.getMessagesBySource('phoneNumber')}"
							var="message">
							<div class="text-danger">${message.text}</div>					
						</c:forEach>
					</div>
