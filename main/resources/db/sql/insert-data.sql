...
insert into contact (first_name, last_name, birth_date, version) values ('Chris', 'Schaefer', '1981-05-03', 0);
insert into contact (first_name, last_name, birth_date, version) values ('Scott', 'Tiger', '1990-11-02', 0);
insert into contact (first_name, last_name, birth_date, version) values ('John', 'Smith', '1964-02-28', 0);